...
<div class="container">
    ...
    <hr/>
    <form  method="GET" action="../app/upData/updataresponse.php" enctype="multipart/form-data"  id="form1">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="account" placeholder="<?php echo $Complaintlist[0]['account'] ?>" id="account" readonly="readonly"/>
    </div>
    <div class="form-group">
